...
#Sub bagian H
cat("H.\n")
cat("Banyak kematian akibat kanker tulang berdasarkan simulasi adalah hasil acak dan dapat berbeda dari simulasi ke simulasi. Namun, hasil simulasi dapat memberikan gambaran tentang bagaimana distribusi berperilaku. Dalam simulasi ini, ditemukan bahwa proporsi simulasi yang menghasilkan lebih dari 4 kematian akibat kanker tulang sekitar 0,0198, yang mendekati hasil analitik sebelumnya dari 0,0187. Dari hasil simulasi tersebut, dapat dilihat bahwa distribusi kematian akibat kanker tulang memiliki ekor yang panjang di sebelah kanan, yang berarti bahwa kemungkinan terdapat kematian akibat kanker tulang yang lebih dari 4 cukup besar. Namun, karena proporsi tersebut masih relatif kecil, dapat disimpulkan bahwa 4 kematian akibat kanker tulang pada kalangan pekerja pabrik ban bukanlah peristiwa yang sangat tidak biasa. Dibandingkan dengan jawaban pada pertanyaan 2d, hasil simulasi cukup dekat dengan hasil analitik sebelumnya. Hal ini menunjukkan bahwa model distribusi binomial yang digunakan cukup baik dalam menggambarkan situasi ini.")
